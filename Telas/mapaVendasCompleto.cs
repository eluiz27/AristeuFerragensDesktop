...
namespace processosAdministrativos.Telas
{
    public partial class mapaVendasCompleto : Form
    {
        ...
        public void preecheTabela()
        {
            ...
            excel ex = new excel(@"\\POSEIDON\documentos\Informatica\Luiz\MV\MV\MV_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx", "123");
        ...
        public void preecheTabela2()
        {
            ...
            excel ex = new excel(@"\\POSEIDON\documentos\Informatica\Luiz\MV\Vendedores\RKG_VDD_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx", "");
            excel e = new excel(@"\\POSEIDON\documentos\Informatica\Luiz\MV\MV\MV_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx", "123");
            ...
            ex.Save();
            ex.Close();
            String strCaminhoNomeArquivo = @"\\POSEIDON\documentos\Informatica\Luiz\MV\MV\MV_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx";
            String strCaminhoNomeArquivo2 = @"\\POSEIDON\documentos\Informatica\Luiz\MV\Vendedores\RKG_VDD_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx";
        ...
        private void enviarBt_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (emailsMv != string.Empty)
                {
                    ...
                    mail.Attachments.Add(@"\\POSEIDON\documentos\Informatica\Luiz\MV\MV\MV_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx", Outlook.OlAttachmentType.olByValue, Type.Missing, Type.Missing);
            ...
            try
            {
                ...
                if (emailsIndVend != string.Empty)
                {
                    ...
                    mail.Importance = Outlook.OlImportance.olImportanceNormal;
                    mail.Attachments.Add(@"\\POSEIDON\documentos\Informatica\Luiz\MV\Vendedores\RKG_VDD_" + mesExtenso.Substring(0, 3).ToUpper() + "_" + ano + ".xlsx", Outlook.OlAttachmentType.olByValue, Type.Missing, Type.Missing);
                    //((Outlook.MailItem)mail).Send();
                }
                else
