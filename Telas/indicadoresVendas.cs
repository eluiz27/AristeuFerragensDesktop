    ...
    public partial class indicadoresVendas : Form
    {
        ...
        public void preenchePlanilha()
        {
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                ...
                ex.writeCell2(qtdePlan, 3, 11, dataGridView1.Rows[i].Cells[6].Value.ToString(), vddsNome[i]);
                ex.writeCell2(qtdePlan, 3, 12, dataGridView1.Rows[i].Cells[7].Value.ToString(), vddsNome[i]);
                ex.writeCell2(qtdePlan, 3, 13, dataGridView1.Rows[i].Cells[8].Value.ToString(), vddsNome[i]);
                ex.writeCell2(qtdePlan, 3, 14, meta, vddsNome[i]);
            }
